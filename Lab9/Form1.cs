...
namespace Lab9
{
    ...
    {
        private static string locatieSolutie = Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName;
        ...
        private string fileVertex = locatieSolutie + "\\Lab9\\vertexList.txt";
        private string fileQList = locatieSolutie + "\\Lab9\\quadsVertexList.txt";
        private string fileTList = locatieSolutie + "\\Lab9\\trianglesVertexList.txt";
        ...
        private void LoadTextures()
        {
            ...
            LoadTexture(textures[0], locatieSolutie + "\\Lab9\\Resources\\brickTexture.jpg");
            LoadTexture(textures[1], locatieSolutie + "\\Lab9\\Resources\\OpenGLTexture.png");
        }
